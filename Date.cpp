...
ostream &operator<<(ostream &output, Date outDate)
{
	output << setw(2) << setfill('0') << outDate.getDay() << '/' << setw(2) << setfill('0')
		<< outDate.getMonth() << '/' << setw(4) << setfill('0') << outDate.getMonth() << endl;
	return output;
}
